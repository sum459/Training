...
2.7.0 :113 > h.sort_by {|k,v| v}.last(2)
 => [[4, 4], [3, 4]] 

2.7.0 :120 > b.max_by{|x| b.count(x)}
2.7.0 :121 >   
 => 4 
2.7.0 :122 > b.min_by{|x| b.count(x)}
2.7.0 :123 >   
 => 10 
2.7.0 :137 > b.group_by {|x| x%2==0}
 => {true=>[10, 4, 52, 2, 4, 4, 4, 5232, 32, 2], false=>[23, 3, 3, 5, 5, 3, 3, 1]} 

2.7.0 :038 > a=Array.new(3){p Array.new(4,"X")}
["X", "X", "X", "X"]
["X", "X", "X", "X"]
["X", "X", "X", "X"]


2.7.0 :046 > require 'matrix'
 => false 
2.7.0 :047 > a=Matrix.zero(2)
2.7.0 :048 > a
 => Matrix[[0, 0], [0, 0]] 

2.7.0 :050 > a=Matrix[[1,2,3,8],[1,4,7,8]]
2.7.0 :051 > a
 => Matrix[[1, 2, 3, 8], [1, 4, 7, 8]] 
...
2.7.0 :002 > a.reduce(:+)
 => 10 
2.7.0 :003 > a.map(&->i{i*2})
 => [2, 4, 6, 8] 
2.7.0 :004 > x=(1..100).lazy
2.7.0 :005 > x.first(15)
